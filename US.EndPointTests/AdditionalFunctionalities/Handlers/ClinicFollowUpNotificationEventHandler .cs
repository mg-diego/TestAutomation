...
{
    public class ClinicFollowUpNotificationEventHandler : EventHandlerBase<ClinicFollowUpNotification>
    {
        ...
        protected override Task HandleInternal(ClinicFollowUpNotification domainEvent, IMessageHeaders headers, CancellationToken cancellationToken = default(CancellationToken))
        {

...
namespace US.EndPointTests.AdditionalFunctionalities.Handlers
{
    ...
    public class ResultFollowUpNotificationEventHandler : EventHandlerBase<ResultFollowUpNotification>
    {
        ...
        protected override Task HandleInternal(ResultFollowUpNotification domainEvent, IMessageHeaders headers, CancellationToken cancellationToken = default(CancellationToken))
        {

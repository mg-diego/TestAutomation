...
{
    public class BarcodeProcesedEventHandler : EventHandlerBase<BarcodeReleasedPushNotification>
    {
        ...
        protected override Task HandleInternal(BarcodeReleasedPushNotification domainEvent, IMessageHeaders headers, CancellationToken cancellationToken = default(CancellationToken))
        {
